...
<head>
        ...
        <style>#seletor{ float:left; }</style>
...
<body>
		...
		<div class="wrap">
			...
			<section class="sessao">
				...
				<form name="cadastro-participante" method="POST" action="update_participante.php" >
					<span class="titulo">ECHO ID : <?php echo $id; ?> </span>


                   
					<h6 align="center">Nome</h6>
					<input class="campo-cadastro" type="text" name="participante-nome" value="<?php echo $linhas['part_nome']?>"> 
                    </br>
                    <h6 align="center">Sobrenome</h6>
					<input class="campo-cadastro" type="text" name="participante-sobrenome"  value="<?php echo $linhas['part_sobrenome']?>">
					</br>
                    <h6 align="center">Telefone</h6>
					<input class="campo-cadastro" type="text" name="participante-telefone"  data-mask="(99)9999-9999" value="<?php echo $linhas['part_telefone']=mascara_string('(##)####-####',$linhas['part_telefone']);?>" >
					</br>
                    <h6 align="center">Data de nascimento</h6>
					<input class="campo-cadastro" type="text" name="participante-data-nascimento" data-mask="99/99/9999"  value="<?php echo $linhas['part_data_nasc'] = implode(	'',array_reverse(explode('-',$linhas['part_data_nasc']))); ?> " >
					</br>
					<h6 align="center">Nome do Responsavel</h6>
					<input class="campo-cadastro" type="text" name="participante-responsavel"  value="<?php echo $linhas['part_respon']?>" >
					</br>
                    
					<h6 align="center">Telefone do Responsavel</h6>
					<input class="campo-cadastro" type="text" name="participante-telefone-responsavel" data-mask="(99)9999-9999" value="<?php echo $linhas['part_respon_tel']=mascara_string('(##)####-####',$linhas['part_respon_tel']);?>" >
					</br>
                    <h6 align="center">E-mail</h6>
					<input class="campo-cadastro" type="text" name="participante-email" value="<?php echo $linhas['part_email']?>" >
					</br>
                    <h6 align="center">Nivel de instrução</h6>
                    
                    <select align="center" name="participante-nivel-instrucao" required="required">
                    
										 <option value="<?php echo $linhas['part_nvl_instru'];?>">Selecione</option>
                    ...
                    <button class="botao-cadastrar">Salvar</button>
